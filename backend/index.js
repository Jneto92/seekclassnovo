...
//rotas
    ...
    app.post('/cadaviso/:professor/:materia/:turma/:aviso', (req, res)=>{
        Avisos.create({
            professor: req.params.professor,
            materia: req.params.materia,
            turma: req.params.turma,
            aviso: req.params.aviso
        })
    });
    ...
    app.get('/materias/:semestre/:turno', (req, res)=>{
        /*Usuario.findAll().then((usuario)=>{
            res.send(usuario);
        })*/
        Grade.findAll({
        ...
        Usuario.findOne({
            where: {
             ...
             if(usuario){
                ...
                res.redirect('http://192.168.15.21:4000/');
             }else{
